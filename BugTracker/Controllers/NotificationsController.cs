...
namespace BugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,CreatorId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,CreatorId")] Notification notification)
        {
            if (ModelState.IsValid)
            {
