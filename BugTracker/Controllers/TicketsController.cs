...
namespace BugTracker.Controllers
{
    ...
    public class TicketsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.TypeId = new SelectList(db.TicketTypes, "Id", "TypeofTicket");

            // prepopulate dropdownlist with available Projects
            ViewBag.ProjectId = new SelectList(db.Projects, "Id", "ProjectName");

            // populate dropdownlist of available developers
            //ViewBag.Developer = new MultiSelectList(db.Roles.Find("Developer").Users.Select(r => r.UserId));
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin,Project Manager")]
        public ActionResult Edit([Bind(Include = "Id,CreateDate,CreateBy,Title,Description,Attachment,ProjectId,StatusId,PriorityId,TypeId")] Ticket ticket)
        {
            if (ModelState.IsValid)
            {
